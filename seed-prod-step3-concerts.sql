-- Step 3: Concerts and Events
PRAGMA foreign_keys = OFF;

-- Kerstconcert 2024
INSERT INTO events (id, type, titel, slug, beschrijving, start_at, end_at, locatie, adres, is_publiek, doelgroep, created_by) VALUES
(1, 'concert', 'Kerstconcert 2024', 'kerstconcert-2024', 
...
INSERT INTO events (id, type, titel, slug, beschrijving, start_at, end_at, locatie, adres, is_publiek, doelgroep, created_by) VALUES
(2, 'concert', 'Voorjaarsconcert: Mozart & Vivaldi', 'voorjaarsconcert-2025',
...
-- Zomerconcert 2025
INSERT INTO events (id, type, titel, slug, beschrijving, start_at, end_at, locatie, adres, is_publiek, doelgroep, created_by) VALUES
(3, 'concert', 'Zomerconcert: Carmina Burana', 'zomerconcert-2025',
...
-- Wekelijkse repetities parent event
INSERT INTO events (id, type, titel, beschrijving, start_at, end_at, locatie, is_publiek, is_recurring, recurrence_rule, created_by) VALUES
(4, 'repetitie', 'Wekelijkse Koorrepetitie', 
...
'2024-11-20 19:30:00', '2024-11-20 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2024-11-20', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2024-11-27 19:30:00', '2024-11-27 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2024-11-27', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2024-12-04 19:30:00', '2024-12-04 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2024-12-04', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2024-12-11 19:30:00', '2024-12-11 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2024-12-11', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Laatste repetitie voor Kerstconcert!', 
'2024-12-18 19:30:00', '2024-12-18 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2024-12-18', 1);

-- Repetities January 2025
INSERT INTO events (type, titel, beschrijving, start_at, end_at, locatie, is_publiek, parent_event_id, occurrence_date, created_by) VALUES
('repetitie', 'Wekelijkse Koorrepetitie', 'Eerste repetitie van het nieuwe jaar!', 
'2025-01-08 19:30:00', '2025-01-08 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2025-01-08', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2025-01-15 19:30:00', '2025-01-15 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2025-01-15', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2025-01-22 19:30:00', '2025-01-22 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2025-01-22', 1),
('repetitie', 'Wekelijkse Koorrepetitie', 'Wekelijkse repetitie voor alle leden. Breng je partituur en een flesje water mee!', 
'2025-01-29 19:30:00', '2025-01-29 21:00:00', 'Repetitielokaal Animato, Kerkstraat 15, 3000 Leuven', 1, 4, '2025-01-29', 1);
