...
INSERT INTO "d1_migrations" VALUES(1,'0001_initial_schema.sql','2025-11-22 17:58:46');
INSERT INTO "d1_migrations" VALUES(2,'0002_fotoboek_updates.sql','2025-11-22 17:58:46');
INSERT INTO "d1_migrations" VALUES(3,'0003_smoelenboek_fields.sql','2025-11-22 17:58:47');
INSERT INTO "d1_migrations" VALUES(4,'0003_add_event_images.sql','2025-11-22 17:58:47');
INSERT INTO "d1_migrations" VALUES(5,'0004_singer_type.sql','2025-11-22 17:58:48');
INSERT INTO "d1_migrations" VALUES(6,'0004_add_concert_practical_info.sql','2025-11-22 17:58:48');
INSERT INTO "d1_migrations" VALUES(7,'0005_recurring_events.sql','2025-11-22 17:58:48');
INSERT INTO "d1_migrations" VALUES(8,'0006_events_extra_fields.sql','2025-11-22 17:58:49');
INSERT INTO "d1_migrations" VALUES(9,'0007_events_locatie_nullable.sql','2025-11-22 17:58:49');
INSERT INTO "d1_migrations" VALUES(10,'0008_add_drums_stemgroep.sql','2025-11-22 17:58:50');
CREATE TABLE users (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO "users" VALUES(1,'admin@animato.be','879bf9fc06a2f7ceeb1cf2b04cdc2b08:d0cdda09784edcd39f8da7668798229b16c363597be230d3e5f53c0bfbaf2cc0','admin',NULL,'actief',0,NULL,1,'2025-11-22 22:54:15','2025-11-22 17:59:13','2025-11-22 17:59:13');
...
INSERT INTO "audit_logs" VALUES(1,1,'user_login','user',1,'{"method":"password","remember":false}',NULL,NULL,'2025-11-22 18:03:30');
INSERT INTO "audit_logs" VALUES(2,1,'user_login','user',1,'{"method":"password","remember":false}',NULL,NULL,'2025-11-22 22:54:15');
...
INSERT INTO "settings" VALUES(1,'site_naam','Gemengd Koor Animato','string','Officiële naam van het koor','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(2,'site_tagline','Koor met passie','string','Tagline onder logo','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(3,'theme_primary_color','#00A9CE','string','Primaire kleur (cyan/turquoise)','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(4,'theme_secondary_color','#1B4D5C','string','Secundaire kleur (donkere teal)','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(5,'theme_accent_color','#F59E0B','string','Accentkleur (amber)','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(6,'contact_email','info@animato.be','string','Algemeen contactadres','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(7,'contact_telefoon','+32 470 12 34 56','string','Algemeen telefoonnummer','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(8,'adres_straat','Koorstraat 1','string','Straatnaam en huisnummer','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(9,'adres_postcode','1000','string','Postcode','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(10,'adres_stad','Brussel','string','Stad','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(11,'enable_ticketing','true','boolean','Ticketing module ingeschakeld','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(12,'enable_2fa','false','boolean','2FA optioneel voor leden','2025-11-22 17:59:23');
INSERT INTO "settings" VALUES(13,'max_file_size_mb','8','number','Maximale bestandsgrootte in MB','2025-11-22 17:59:23');
...
INSERT INTO "locations" VALUES(1,'Repetitielokaal Koor','Koorstraat 1','1000','Brussel','België',NULL,NULL,NULL,NULL,NULL,1,'2025-11-22 17:58:48','2025-11-22 17:58:48');
INSERT INTO "locations" VALUES(2,'Sint-Pieterskerk','Sint-Pietersplein 1','9000','Gent','België',NULL,NULL,NULL,NULL,NULL,1,'2025-11-22 17:58:48','2025-11-22 17:58:48');
INSERT INTO "locations" VALUES(3,'Concertgebouw','Concertgebouwplein 1','8000','Brugge','België',NULL,NULL,NULL,NULL,NULL,1,'2025-11-22 17:58:48','2025-11-22 17:58:48');
...
INSERT INTO "sqlite_sequence" VALUES('audit_logs',2);
