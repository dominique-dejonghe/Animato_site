...
INSERT INTO walkthrough_tours (tour_key, title, description, target_role, is_active, auto_start, sort_order, icon) VALUES
('admin-basics', 'Admin Basics', 'Leer de basis van het admin panel kennen in 5 minuten', 'admin', 1, 1, 1, 'fas fa-graduation-cap');

INSERT INTO walkthrough_steps (tour_id, step_number, title, description, target_element, target_url, position) VALUES
